...
import 'package:vet_bookr/models/total_data.dart';
...
class _VetsMapsState extends State<VetsMaps> {
  ...
  Future<TotalData> getTotalData() async {
    ...
    String vetsUrl =
        ...
        "&origin=Space+Needle+Seattle+WA&destination=Pike+Place+Market+Seattle+WA&travelmode=bicycling&key=${Constants
        .apiKey}";

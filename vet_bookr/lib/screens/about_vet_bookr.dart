      ...
      body: ListView(
        children: [Column(
          ...
          children: [
            ...
            Text("Set reminders on everything your pet needs - from giving your pet medication to scheduling appointments to buying food and more.", style: TextStyle(fontSize: 12)),
            Text("Request Appointments and Prescription Refills.", style: TextStyle(fontSize: 14)),
            Text("If your veterinary practice partners with us, you can easily request appointments, medication refills, and products directly through the app.", style: TextStyle(fontSize: 12)),
            Text("Download Vet Bookr to keep your dog, cat, rabbit, bird, turtle, or whoever your friend is, healthy and safe.", style: TextStyle(fontSize: 14)),
            ElevatedButton(onPressed: (){Navigator.push(context,MaterialPageRoute(builder: (context) => TermsScreen()));}, child: Text("Next"))
